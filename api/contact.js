...
function buildHtml({ name, email, message, selectedItem, selectedType }) {
  ...
  return `
    ...
    <div style="margin:0; padding:36px 16px; background:#edf3f9; font-family:Arial, Helvetica, sans-serif; color:#16324d;">
      <div style="max-width:720px; margin:0 auto;">
        ...
        <div style="background:#ffffff; border:1px solid #d7e3ef; border-radius:28px; overflow:hidden; box-shadow:0 22px 60px rgba(18,48,78,0.08);">
          ...
          <div style="padding:30px 32px 18px; background:
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
              <tr>
                <td style="padding:0; vertical-align:top;">
                  ...
                  <h1 style="margin:0 0 12px; font-size:30px; line-height:1.16; color:#102739;">${safeName} just contacted you</h1>
                  <p style="margin:0; font-size:15px; line-height:1.7; color:#56708b;">
                    A new message was sent through your PM Digital Solutions contact form.
                  </p>
                </td>
                <td style="width:170px; padding:0; vertical-align:top; text-align:right;">
          ...
          <div style="padding:0 32px 32px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:separate; border-spacing:0 16px;">
              <tr>
                <td style="width:42%; vertical-align:top;">
                  <div style="padding:20px 20px 18px; background:#f8fbfe; border:1px solid #dbe7f2; border-radius:20px;">
                ...
                <td style="vertical-align:top;">
                  <div style="padding:20px 22px; background:#ffffff; border:1px solid #dbe7f2; border-radius:20px;">
                    ...
                    <div style="padding:18px; background:#f9fcff; border-left:4px solid #1d72ff; border-radius:14px; font-size:15px; line-height:1.8; color:#16324d;">
                      ${safeMessage}
                    </div>
                  </div>
                </td>
            ...
            <div style="margin-top:8px; padding:22px; background:linear-gradient(135deg, #102739 0%, #163c63 100%); border-radius:22px; color:#ffffff;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                <tr>
                  ...
                  <td style="width:170px; vertical-align:middle; text-align:right;">
                    <a href="mailto:${safeEmail}" style="display:inline-block; padding:13px 20px; border-radius:999px; background:#ffffff; color:#0c54d4; text-decoration:none; font-size:14px; font-weight:700;">Reply now</a>
                  </td>
                </tr>
              </table>
            </div>
